package com.yui.smart.admin.module.support.codegenerator.service;
...
import com.yui.smart.admin.module.support.codegenerator.domain.ColumnVO;
import com.yui.smart.admin.module.support.codegenerator.domain.QueryFieldVO;
import com.yui.smart.admin.module.support.codegenerator.dao.TableDao;
...
public class CodeGeneratorService {
    ...
    public void codeGenerator(CodeGeneratorDTO codeGenerator) throws Exception {
        ...
        if (StringUtils.isEmpty(basePackage)) {
            basePackage = "com.yui.smart.admin";
        }

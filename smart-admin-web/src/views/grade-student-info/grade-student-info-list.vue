    ...
    <div>
        <Card class="smart-query-card">
            ...
            <Row class="smart-query-form-row">
                <span>
                    班级编码 :
                    <Input placeholder="请输入班级编码" style="width: 180px" v-model="queryForm.gradeCode" />
                </span>
                <span>
                    状态（1：正常，2：结束，3:取消，4：结转） :
                    <Input placeholder="请输入状态（1：正常，2：结束，3:取消，4：结转）" style="width: 180px" v-model="queryForm.status" />
                </span>
                <ButtonGroup>
                    <Button
                            @click="queryList"
                            icon="ios-search"
                            type="primary"
                            v-privilege="'grade-student-info-list-query'"
                    >查询</Button>
                    <Button
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                <Button
                        @click="showAddGradeStudentInfoForm"
                        icon="md-add"
                        size="small"
                        type="primary"
                        v-privilege="'grade-student-info-list-add'"
                >新建数据</Button>
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'grade-student-info-list-batch-delete'"
                >批量删除</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'grade-student-info-list-export-all'"
                >导出全部</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'grade-student-info-list-batch-export'"
                >批量导出</Button>
...
<script>
    ...
    import GradeStudentInfoListForm from './components/grade-student-info-list-form';
                    ...
                    columnArray: [
                        {
                            ...
                            title: '主键id',
                            key: 'id',
                            tableColumn: 'h_grade_student_info.id',
                            sortable: 'custom'
                        },
                                                {
                            title: '班级编码',
                            key: 'gradeCode',
                            tableColumn: 'h_grade_student_info.grade_code',
                            sortable: 'custom'
                        },
                                                {
                            title: '学生信息id',
                            key: 'studentInfoId',
                            tableColumn: 'h_grade_student_info.student_info_id',
                            sortable: 'custom'
                        },
                                                {
                            title: '缴费金额',
                            key: 'payAmount',
                            tableColumn: 'h_grade_student_info.pay_amount',
                            sortable: 'custom'
                        },
                                                {
                            title: '结转课时',
                            key: 'settlementClassHours',
                            tableColumn: 'h_grade_student_info.settlement_class_hours',
                            sortable: 'custom'
                        },
                                                {
                            title: '状态（1：正常，2：结束，3:取消，4：结转）',
                            key: 'status',
                            tableColumn: 'h_grade_student_info.status',
                            sortable: 'custom'
                        },
                                                {
                            title: '总课时',
                            key: 'totalClassHours',
                            tableColumn: 'h_grade_student_info.total_class_hours',
                            sortable: 'custom'
                        },
                                                {
                            title: '已上课时',
                            key: 'usedClassHours',
                            tableColumn: 'h_grade_student_info.used_class_hours',
                            sortable: 'custom'
                        },
                                                {
                            title: '创建时间',
                            key: 'createTime',
                            tableColumn: 'h_grade_student_info.create_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '更新时间',
                            key: 'updateTime',
                            tableColumn: 'h_grade_student_info.update_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '操作',
                                ...
                                let actions = [
                                    {
                                        ...
                                        directives: [
                                            {
                                                name: 'privilege',
                                                value: 'grade-student-info-list-update'
                                            }
                                        ],
                                        action: () => {
                                            this.showEditGradeStudentInfoForm(params.row);
                                        }
                                    }
                                ];
        ...
        methods: {
            ...
            async queryList() {
                ...
                try {
                    ...
                    let result = await gradeStudentInfoApi.queryGradeStudentInfo(params);
            ...
            async batchDelete() {
                this.$Spin.show();
                await gradeStudentInfoApi.batchDeleteGradeStudentInfo(
            ...
            async exportAll(){
                try{
                    ...
                    let params = this.convertQueryParam();
                    await gradeStudentInfoApi.exportAll(params);
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            async batchExport(){
                ...
                try{
                    ...
                    await gradeStudentInfoApi.batchExport(this.mainTableSelectArray.map(e => e.id));
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            /*-------------------------添加，修改 表单 begin------------------------- */
            //显示添加表单
            showAddGradeStudentInfoForm() {
                this.saveModal.isUpdate = false;
                this.saveModal.show = true;
            },
            showEditGradeStudentInfoForm(updateObject){

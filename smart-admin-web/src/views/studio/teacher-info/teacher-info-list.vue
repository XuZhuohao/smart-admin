    ...
    <div>
            ...
            <Row class="smart-query-form-row">
                ...
                <ButtonGroup>
                    <Button
                            ...
                            icon="ios-search"
                            type="primary"
                            v-privilege="'teacher-info-list-query'"
                    >查询</Button>
                    <Button
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                <Button
                        @click="showAddTeacherInfoForm"
                        icon="md-add"
                        size="small"
                        type="primary"
                        v-privilege="'teacher-info-list-add'"
                >新建数据</Button>
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'teacher-info-list-batch-delete'"
                >批量删除</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'teacher-info-list-export-all'"
                >导出全部</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'teacher-info-list-batch-export'"
                >批量导出</Button>
                    ...
                    columnArray: [
                        {
                            ...
                            title: '主键id',
                            key: 'id',
                            tableColumn: 'h_teacher_info.id',
                            sortable: 'custom'
                        },
                                                {
                            title: '姓名',
                            key: 'name',
                            tableColumn: 'h_teacher_info.name',
                            sortable: 'custom'
                        },
                                                {
                            title: '生日',
                            key: 'birthDate',
                            tableColumn: 'h_teacher_info.birth_date',
                            sortable: 'custom'
                        },
                                                {
                            title: '性别',
                            ...
                            title: '兴趣',
                            key: 'interest',
                            tableColumn: 'h_teacher_info.interest',
                            sortable: 'custom'
                        },
                                                {
                            title: '备注',
                            key: 'remark',
                            tableColumn: 'h_teacher_info.remark',
                            sortable: 'custom'
                        },
                                                {
                            title: '联系电话',
                            ...
                            title: '创建时间',
                            key: 'createTime',
                            tableColumn: 'h_teacher_info.create_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '更新时间',
                            key: 'updateTime',
                            tableColumn: 'h_teacher_info.update_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '课程方向:',
                            key: 'courseDirection',
                            tableColumn: 'h_teacher_info.course_direction',
                            sortable: 'custom'
                        },
                                                {
                            title: '操作',
                                ...
                                let actions = [
                                    {
                                        ...
                                        directives: [
                                            {
                                                name: 'privilege',
                                                value: 'teacher-info-list-update'
                                            }
                                        ],
                                        action: () => {
                                            this.showEditTeacherInfoForm(params.row);
                                        }
                                    }
                                ];
        ...
        methods: {
            ...
            async queryList() {
                ...
                try {
                    ...
                    let result = await teacherInfoApi.queryTeacherInfo(params);
            ...
            async batchDelete() {
                this.$Spin.show();
                await teacherInfoApi.batchDeleteTeacherInfo(
            ...
            async exportAll(){
                try{
                    ...
                    let params = this.convertQueryParam();
                    await teacherInfoApi.exportAll(params);
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            async batchExport(){
                ...
                try{
                    ...
                    await teacherInfoApi.batchExport(this.mainTableSelectArray.map(e => e.id));
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            /*-------------------------添加，修改 表单 begin------------------------- */
            //显示添加表单
            showAddTeacherInfoForm() {
                this.saveModal.isUpdate = false;
                this.saveModal.show = true;
            },
            showEditTeacherInfoForm(updateObject){

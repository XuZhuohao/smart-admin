    ...
    <div>
        <Card class="smart-query-card">
            ...
            <Row class="smart-query-form-row">
                <span>
                    课程编码 :
                    <Input placeholder="请输入课程编码" style="width: 180px" v-model="queryForm.projectCode" />
                </span>
                <span>
                    班级编码 :
                ...
                <span>
                    课程名称 :
                    <Input placeholder="请输入课程名称" style="width: 180px" v-model="queryForm.gradeName" />
                </span>
                <span>
                    状态（1：正常，2：结束，3:取消） :
                ...
                <ButtonGroup>
                    <Button
                            ...
                            icon="ios-search"
                            type="primary"
                            v-privilege="'grade-info-list-query'"
                    >查询</Button>
                    <Button
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                <Button
                        @click="showAddGradeInfoForm"
                        icon="md-add"
                        size="small"
                        type="primary"
                        v-privilege="'grade-info-list-add'"
                >新建数据</Button>
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'grade-info-list-batch-delete'"
                >批量删除</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'grade-info-list-export-all'"
                >导出全部</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'grade-info-list-batch-export'"
                >批量导出</Button>
...
<script>
    ...
    import GradeInfoListForm from './components/grade-info-list-form';
                    ...
                    columnArray: [
                        {
                            ...
                            title: '主键id',
                            key: 'id',
                            tableColumn: 'h_grade_info.id',
                            sortable: 'custom'
                        },
                                                {
                            title: '课程编码',
                            key: 'projectCode',
                            tableColumn: 'h_grade_info.project_code',
                            sortable: 'custom'
                        },
                                                {
                            title: '班级编码',
                            key: 'gradeCode',
                            tableColumn: 'h_grade_info.grade_code',
                            sortable: 'custom'
                        },
                                                {
                            title: '课程名称',
                            key: 'gradeName',
                            tableColumn: 'h_grade_info.grade_name',
                            sortable: 'custom'
                        },
                                                {
                            title: '地点',
                            key: 'gradePlace',
                            tableColumn: 'h_grade_info.grade_place',
                            sortable: 'custom'
                        },
                                                {
                            title: '状态（1：正常，2：结束，3:取消）',
                            key: 'status',
                            tableColumn: 'h_grade_info.status',
                            sortable: 'custom'
                        },
                                                {
                            title: '开课时间',
                            key: 'startTime',
                            tableColumn: 'h_grade_info.start_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '结课时间',
                            key: 'endTime',
                            tableColumn: 'h_grade_info.end_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '总课时',
                            key: 'totalClassHours',
                            tableColumn: 'h_grade_info.total_class_hours',
                            sortable: 'custom'
                        },
                                                {
                            title: '已用课时',
                            key: 'usedClassHours',
                            tableColumn: 'h_grade_info.used_class_hours',
                            sortable: 'custom'
                        },
                                                {
                            title: '创建时间',
                            key: 'createTime',
                            tableColumn: 'h_grade_info.create_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '更新时间',
                            key: 'updateTime',
                            tableColumn: 'h_grade_info.update_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '操作',
                                ...
                                let actions = [
                                    {
                                        ...
                                        directives: [
                                            {
                                                name: 'privilege',
                                                value: 'grade-info-list-update'
                                            }
                                        ],
                                        action: () => {
                                            this.showEditGradeInfoForm(params.row);
                                        }
                                    }
                                ];
        ...
        methods: {
            ...
            async queryList() {
                ...
                try {
                    ...
                    let result = await gradeInfoApi.queryGradeInfo(params);
            ...
            async batchDelete() {
                this.$Spin.show();
                await gradeInfoApi.batchDeleteGradeInfo(
            ...
            async exportAll(){
                try{
                    ...
                    let params = this.convertQueryParam();
                    await gradeInfoApi.exportAll(params);
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            async batchExport(){
                ...
                try{
                    ...
                    await gradeInfoApi.batchExport(this.mainTableSelectArray.map(e => e.id));
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            /*-------------------------添加，修改 表单 begin------------------------- */
            //显示添加表单
            showAddGradeInfoForm() {
                this.saveModal.isUpdate = false;
                this.saveModal.show = true;
            },
            showEditGradeInfoForm(updateObject){

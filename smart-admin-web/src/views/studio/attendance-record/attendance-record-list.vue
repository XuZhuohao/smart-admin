    ...
    <div>
            ...
            <Row class="smart-query-form-row">
                ...
                <ButtonGroup>
                    <Button
                            ...
                            icon="ios-search"
                            type="primary"
                            v-privilege="'attendance-record-list-query'"
                    >查询</Button>
                    <Button
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                <Button
                        @click="showAddAttendanceRecordForm"
                        icon="md-add"
                        size="small"
                        type="primary"
                        v-privilege="'attendance-record-list-add'"
                >新建数据</Button>
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'attendance-record-list-batch-delete'"
                >批量删除</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'attendance-record-list-export-all'"
                >导出全部</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'attendance-record-list-batch-export'"
                >批量导出</Button>
...
<script>
    ...
    import AttendanceRecordListForm from './components/attendance-record-list-form';
                    ...
                    columnArray: [
                        {
                            ...
                            title: '主键id',
                            key: 'id',
                            tableColumn: 'h_attendance_record.id',
                            sortable: 'custom'
                        },
                                                {
                            title: '班级编码',
                            key: 'gradeCode',
                            tableColumn: 'h_attendance_record.grade_code',
                            sortable: 'custom'
                        },
                                                {
                            title: '占用课时',
                            key: 'occupyClassHour',
                            tableColumn: 'h_attendance_record.occupy_class_hour',
                            sortable: 'custom'
                        },
                                                {
                            title: '考勤开始时间',
                            key: 'attendTimeBegin',
                            tableColumn: 'h_attendance_record.attend_time_begin',
                            sortable: 'custom'
                        },
                                                {
                            title: '考勤结束时间',
                            key: 'attendTimeEnd',
                            tableColumn: 'h_attendance_record.attend_time_end',
                            sortable: 'custom'
                        },
                                                {
                            title: '应出席人数',
                            key: 'shouldAttendNumber',
                            tableColumn: 'h_attendance_record.should_attend_number',
                            sortable: 'custom'
                        },
                                                {
                            title: '实际出席人数',
                            key: 'attendNumber',
                            tableColumn: 'h_attendance_record.attend_number',
                            sortable: 'custom'
                        },
                                                {
                            title: '类型（1：正常，2：补课）',
                            key: 'attendType',
                            tableColumn: 'h_attendance_record.attend_type',
                            sortable: 'custom'
                        },
                                                {
                            title: '创建时间',
                            key: 'createTime',
                            tableColumn: 'h_attendance_record.create_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '更新时间',
                            key: 'updateTime',
                            tableColumn: 'h_attendance_record.update_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '操作',
                                ...
                                let actions = [
                                    {
                                        ...
                                        directives: [
                                            {
                                                name: 'privilege',
                                                value: 'attendance-record-list-update'
                                            }
                                        ],
                                        action: () => {
                                            this.showEditAttendanceRecordForm(params.row);
                                        }
                                    }
                                ];
        ...
        methods: {
            ...
            async queryList() {
                ...
                try {
                    ...
                    let result = await attendanceRecordApi.queryAttendanceRecord(params);
            ...
            async batchDelete() {
                this.$Spin.show();
                await attendanceRecordApi.batchDeleteAttendanceRecord(
            ...
            async exportAll(){
                try{
                    ...
                    let params = this.convertQueryParam();
                    await attendanceRecordApi.exportAll(params);
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            async batchExport(){
                ...
                try{
                    ...
                    await attendanceRecordApi.batchExport(this.mainTableSelectArray.map(e => e.id));
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            /*-------------------------添加，修改 表单 begin------------------------- */
            //显示添加表单
            showAddAttendanceRecordForm() {
                this.saveModal.isUpdate = false;
                this.saveModal.show = true;
            },
            showEditAttendanceRecordForm(updateObject){

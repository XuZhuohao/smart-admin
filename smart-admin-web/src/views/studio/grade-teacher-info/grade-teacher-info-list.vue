    ...
    <div>
        <Card class="smart-query-card">
            ...
            <Row class="smart-query-form-row">
                ...
                <span>
                    状态（1：正常，2：结束，3:取消） :
                    <Input placeholder="请输入状态（1：正常，2：结束，3:取消）" style="width: 180px" v-model="queryForm.status" />
                </span>
                <ButtonGroup>
                    <Button
                            @click="queryList"
                            icon="ios-search"
                            type="primary"
                            v-privilege="'grade-teacher-info-list-query'"
                    >查询</Button>
                    <Button
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                <Button
                        @click="showAddGradeTeacherInfoForm"
                        icon="md-add"
                        size="small"
                        type="primary"
                        v-privilege="'grade-teacher-info-list-add'"
                >新建数据</Button>
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'grade-teacher-info-list-batch-delete'"
                >批量删除</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'grade-teacher-info-list-export-all'"
                >导出全部</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'grade-teacher-info-list-batch-export'"
                >批量导出</Button>
...
<script>
    ...
    import GradeTeacherInfoListForm from './components/grade-teacher-info-list-form';
                    ...
                    columnArray: [
                        {
                            ...
                            title: '主键id',
                            key: 'id',
                            tableColumn: 'h_grade_teacher_info.id',
                            sortable: 'custom'
                        },
                                                {
                            title: '班级编码',
                            key: 'gradeCode',
                            tableColumn: 'h_grade_teacher_info.grade_code',
                            sortable: 'custom'
                        },
                                                {
                            title: '老师信息id',
                            key: 'techerInfoId',
                            tableColumn: 'h_grade_teacher_info.techer_info_id',
                            sortable: 'custom'
                        },
                                                {
                            title: '预计课酬',
                            key: 'shouldPayWages',
                            tableColumn: 'h_grade_teacher_info.should_pay_wages',
                            sortable: 'custom'
                        },
                                                {
                            title: '状态（1：正常，2：结束，3:取消）',
                            key: 'status',
                            tableColumn: 'h_grade_teacher_info.status',
                            sortable: 'custom'
                        },
                                                {
                            title: '总课时',
                            key: 'totalClassHours',
                            tableColumn: 'h_grade_teacher_info.total_class_hours',
                            sortable: 'custom'
                        },
                                                {
                            title: '完成上课时',
                            key: 'completeClassHours',
                            tableColumn: 'h_grade_teacher_info.complete_class_hours',
                            sortable: 'custom'
                        },
                                                {
                            title: '支付条款编码',
                            key: 'paymentTermsCode',
                            tableColumn: 'h_grade_teacher_info.payment_terms_code',
                            sortable: 'custom'
                        },
                                                {
                            title: '创建时间',
                            key: 'createTime',
                            tableColumn: 'h_grade_teacher_info.create_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '更新时间',
                            key: 'updateTime',
                            tableColumn: 'h_grade_teacher_info.update_time',
                            sortable: 'custom'
                        },
                                                {
                            title: '操作',
                                ...
                                let actions = [
                                    {
                                        ...
                                        directives: [
                                            {
                                                name: 'privilege',
                                                value: 'grade-teacher-info-list-update'
                                            }
                                        ],
                                        action: () => {
                                            this.showEditGradeTeacherInfoForm(params.row);
                                        }
                                    }
                                ];
        ...
        methods: {
            ...
            async queryList() {
                ...
                try {
                    ...
                    let result = await gradeTeacherInfoApi.queryGradeTeacherInfo(params);
            ...
            async batchDelete() {
                this.$Spin.show();
                await gradeTeacherInfoApi.batchDeleteGradeTeacherInfo(
            ...
            async exportAll(){
                try{
                    ...
                    let params = this.convertQueryParam();
                    await gradeTeacherInfoApi.exportAll(params);
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            async batchExport(){
                ...
                try{
                    ...
                    await gradeTeacherInfoApi.batchExport(this.mainTableSelectArray.map(e => e.id));
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            /*-------------------------添加，修改 表单 begin------------------------- */
            //显示添加表单
            showAddGradeTeacherInfoForm() {
                this.saveModal.isUpdate = false;
                this.saveModal.show = true;
            },
            showEditGradeTeacherInfoForm(updateObject){
